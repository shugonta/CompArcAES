...
//  plaintext   = (unsigned char*)malloc(sizeof(unsigned char)*FILESIZE);
  cudaHostAlloc((unsigned char) &plaintext, sizeof(unsigned char) * FILESIZE, cudaHostAllocDefault);
  cudaHostAlloc((unsigned char) &ciphertext2, sizeof(unsigned char) * FILESIZE, cudaHostAllocDefault);
//  plaintext   = (unsigned char*)malloc(sizeof(unsigned char)*FILESIZE);
